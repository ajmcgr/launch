...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // For website/combined, launch URL is required
    if ((sponsorshipType === 'website' || sponsorshipType === 'combined') && !launchUrl) {
      throw new Error('Launch URL is required for website sponsorship');
    }
