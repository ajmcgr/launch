...
Deno.serve(async (req) => {
  ...
  try {
    ...
    html += '.button{display:inline-block;background:#00a0dc;color:#ffffff !important;padding:12px 24px;text-decoration:none;border-radius:6px;font-weight:500;font-size:14px;}';
