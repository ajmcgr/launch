...
DROP POLICY IF EXISTS "Public can read active category sponsors" ON public.category_sponsors;
CREATE POLICY "Public can read active category sponsors"
...
-- Increment helpers (run as definer so anon can increment counters)
