        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Button
              ...
              className={`group flex flex-col items-center gap-0.5 h-auto py-1.5 px-3 min-w-[52px] transition-colors touch-manipulation active:scale-95 border-2 [@media(hover:hover)]:hover:border-primary [@media(hover:hover)]:hover:bg-primary ${userVote === 1 ? 'border-primary bg-primary/10' : 'border-muted-foreground/20'}`}
            >
