    ...
    <>
      ...
      <div className="min-h-screen bg-white py-16">
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="border border-gray-200 rounded-lg p-8 md:p-12 bg-white">
            <h1 className="text-4xl font-bold mb-8 text-center text-gray-900">Vibe Code Your Future</h1>
            ...
            <div className="prose prose-lg prose-gray max-w-none space-y-6">
              ...
              <p className="text-gray-800">
                I did. I built <a href="https://trylaunch.ai/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Launch</a> without any coding experience into the largest vibe code community in the world.
              </p>
              ...
              <div className="mt-12">
                <div className="flex flex-col items-start">
                  ...
                  />
                  <h3 className="text-lg font-bold mb-0 text-gray-900">Alex MacGregor</h3>
                  <p className="text-lg font-bold mb-2 text-gray-700">Founder, Launch</p>
                  <a
